    ...
    /////////////////
    {
        ...
        "Reqs": {
            ...
            "List": [
                { // Required courses
                    "Type": "ALL",
                    "List": ["PHYS114", "PHYS115"],
                    "Text": "Required courses: PHYS114, PHYS115",
                },
                ...
                { // Required courses but optional in some cases (double major)
                    ...
                    "List": ["MATH243"],
                    "Howmany": "1", 
                    "Text": "MATH243 is a required course (could be waived for double majors)",
                },
    ...
    /////////////////
    {
        ...
        "Reqs": {
            ...
            "List": [
                ...
                { // Required courses
                    "Type": "ALL",
                    "List": ["CHEM201", "CHEM202", "CHEM203", "CHEM206"],
                    "Text": "Required courses: CHEM201, CHEM202, CHEM203, CHEM206",
                },
                ...
                { // Required courses but optional in some cases (double major)
                    ...
                    "List": ["CHEM205"],
                    "Howmany": "1", 
                    "Text": "CHEM205 is a required course (could be waived for double majors)",
                },
    ...
    /////////////////
    {
        ...
        "Reqs": {
            ...
            "List": [
                ...
                { // Either (PHYS114 and PHYS115) or (ENGR141 and ENGR142)
                    "Type": "COND",
                    "Bool": "OR",
                    "Text": "Either (PHYS114 and PHYS115) or (ENGR141 and ENGR142)",
                    "List": [
                        {
                            "Type": "ALL",
                            "List": ["PHYS114", "PHYS115"],
    ...
    /////////////////
    {
        ...
        "Reqs": {
            ...
            "List": [
                ...
                { // Either (PHYS114 and PHYS115) or (PHYS114 and PHYS131) or (ENGR141 and ENGR142)
                    "Type": "COND",
                    "Bool": "OR",
                    "Text": "Either (PHYS114 and PHYS115) or (PHYS114 and PHYS131) or (ENGR141 and ENGR142)",
                    "List": [
                        {
                            "Type": "ALL",
                            "List": ["PHYS114", "PHYS115"],
    ...
    /////////////////
    {
        ...
        "Reqs": {
            ...
            "List": [
                ...
                { // One from CHEM113-115, MATH141-177, PHYS114, PHYS115, STAT193
                    "Type": "SOME",
                    "List": ["CHEM113", "CHEM114", "CHEM115", "MATH14?", "MATH15?", "MATH16?", "MATH17?", "PHYS114", "PHYS115", "STAT193"],
                    "Howmany": 1,
                    "Text": "One from CHEM113-115, MATH141-177, PHYS114, PHYS115, STAT193",
                },
                { // One futher course from MATH100-199, PHYS100-199, QUAN100-199, STAT100-199
                    ...
                    "List": [
                        ...
                        { // One of MATH141-177, PHYS114, PHYS115, STAT193 and one futher from MATH100-199, PHYS100-199, QUAN100-199, STAT100-199
                            "Type": "COND",
                            "Bool": "AND",
                            "List": [
                                { // One of MATH141-177, PHYS114, PHYS115, STAT193
                                    "Type": "SOME",
                                    "List": ["MATH14?", "MATH15?", "MATH16?", "MATH17?", "PHYS114", "PHYS115", "STAT193"],
                                    "Howmany": 1,
                                },
